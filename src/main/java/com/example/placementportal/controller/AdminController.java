...
public class AdminController {
    ...
    public List<CoordinatorInfo> getCoordinators() {
        return adminRepository.findAll().stream()
                .filter(admin -> admin.getRole() != null && admin.getRole().contains("Coordinator"))
    ...
    public Map<String, Object> login(@RequestBody Map<String, String> req) {
        ...
        Map<String, Object> response = new HashMap<>();
        if (username != null && username.contains("@") && !username.trim().endsWith("@pccoer.in")) {
            response.put("status", "failed");
    ...
    public Map<String, Object> loginWithGoogle(@RequestBody GoogleLoginRequest req) {
        ...
        if (email == null || !email.endsWith("@pccoer.in")) {
            response.put("status", "failed");
